...
public class QuickSort {
	...
	QuickSort(int size, int tab[], boolean print){
		...
		try{
			System.out.println("Oczekiwanie W¹tku g³ównego na zakoñczenie w¹tków!");
			this.First.First.join();
		}catch (InterruptedException e){
			
		}
		System.out.println(">>Wszystkie w¹tki zosta³y zakoñczone!");
	...
	private class FirstThread implements Runnable{
		...
		@Override
		public void run() {
			System.out.println("<BEGIN>Rozpoczêcie W¹tku: " + First);
			...
			System.out.println("<END>Zakoñczenie W¹tku: " + First);
		}
	}
	private class SecondThread implements Runnable{
		...
		@Override
		public void run() {
			System.out.println("<BEGIN>Rozpoczêcie W¹tku: " + Second);
			...
			System.out.println("<END>Zakoñczenie W¹tku: " + Second);
		}	
	}
	private class AnotherThread implements Runnable{
		...
		@Override
		public void run() {
			System.out.println("<BEGIN>Rozpoczêcie W¹tku: " + Another);
			
			QuickSort.this.sort_till_the_end(from, to);
			
			System.out.println("<END>Zakoñczenie W¹tku: " + Another);
		}
	}
